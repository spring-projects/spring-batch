...
import org.springframework.batch.core.repository.support.MongoJobInstanceDaoIntegrationTests.JobInstanceDaoConfiguration;
 ...
 * @author Yanming Zhou
 */
@ContextConfiguration(classes = JobInstanceDaoConfiguration.class)
class MongoJobInstanceDaoIntegrationTests extends AbstractMongoDBDaoIntegrationTests {
	...
	@Configuration
	static class JobInstanceDaoConfiguration {
