...
class StopAndRestartFailedJobParserTests extends AbstractJobParserTests {
	...
	private JobExecution launchAndAssert(String stepNames) throws JobInstanceAlreadyCompleteException,
			JobRestartException, JobExecutionAlreadyRunningException, JobInterruptedException {
