...
/**
 * This default implementation simply returns the LdapAttributes object and is only
 * intended for test. As its not required to return an object of a specific type to make
 * the MappingLdifReader implementation work, this basic setting is sufficient to
