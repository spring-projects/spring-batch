 ...
 * form of {@link ExecutionContext} instances. The usual aim is to create a set of
 * distinct input values, e.g. a set of non-overlapping primary key ranges, or a set of
 * unique filenames.
 *
 * @author Dave Syer
 * @author Taeik Lim
