...
public class StepParser {
	 ...
	 */
	public static Collection<BeanDefinition> getNextElements(ParserContext parserContext,
		...
		for (Element nextElement : nextElements) {
			...
			BeanDefinition additionalState = null;
	...
	public static BeanDefinition getStateTransitionReference(ParserContext parserContext,
		...
		nextBuilder.setRole(BeanDefinition.ROLE_INFRASTRUCTURE);
