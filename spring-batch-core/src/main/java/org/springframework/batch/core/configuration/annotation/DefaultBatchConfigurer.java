...
public class DefaultBatchConfigurer implements BatchConfigurer {
	 ...
	 * @throws Exception The exception that is thrown if an error occurs while creating the {@link JobLauncher}.
	 */
	 ...
	 * @throws Exception The exception that is thrown if an error occurs while creating the {@link JobRepository}.
	 */
	 ...
	 * @throws Exception The exception that is thrown if an error occurs while creating the {@link JobExplorer}.
	 */
