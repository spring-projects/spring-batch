 ...
 * be aware of the surrounding environment because a {@link RepeatCallback} can always use
 * the context it is passed by the enclosing {@link RepeatOperations}. But occasionally it
 * might be helpful to have lower level access to the ongoing {@link RepeatContext} so we
