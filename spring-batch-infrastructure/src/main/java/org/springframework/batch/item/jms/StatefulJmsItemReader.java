...
public class StatefulJmsItemReader<T> extends AbstractItemCountingItemStreamItemReader<T> implements InitializingBean {
	...
	protected void jumpToItem(final int itemIndex) throws Exception {
		// do nothing as there is no storing of the JMS messages and nothing to jump to
	}
