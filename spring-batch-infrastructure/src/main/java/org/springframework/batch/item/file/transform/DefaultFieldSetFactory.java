...
public class DefaultFieldSetFactory implements FieldSetFactory {
	...
	public FieldSet create(String[] values, String[] names) {
		return dateFormat != null && numberFormat != null //
				? new DefaultFieldSet(values, names, dateFormat, numberFormat) //
				: new DefaultFieldSet(values, names);
	}
	...
	public FieldSet create(String[] values) {
		return dateFormat != null && numberFormat != null //
				? new DefaultFieldSet(values, dateFormat, numberFormat) //
