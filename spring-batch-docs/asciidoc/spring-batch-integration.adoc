...
@Bean
public DirectChannel jobLaunchReplyChannel() {
    return new DirectChannel();
}
...
public FileReadingMessageSource fileReader() {
    ...
    source.setDirectory(new File("/tmp/myfiles"));
...
public IntegrationFlow integrationFlow(JobLaunchingGateway jobLaunchingGateway) {
    return IntegrationFlows.from(fileReader(),
            ...
            .channel(inboundFileChannel()).
                    ...
                    channel(outboundJobRequestChannel()).
                    handle(jobLaunchingGateway).
                    channel(jobLaunchReplyChannel()).
                    handle(logging())
            .get();
}
----
...
public JmsSendingMessageHandler jmsOutboundChannelAdapter() {
	JmsSendingMessageHandler jmsSendingMessageHandler = new JmsSendingMessageHandler(jmsTemplate());
	jmsSendingMessageHandler.setDestinationName("requests");
...
public DefaultMessageListenerContainer defaultMessageListenerContainer() {
	...
	defaultMessageListenerContainer.setDestinationName("replies");
...
@Bean
public JmsMessageDrivenEndpoint jmsReplies() {
	JmsMessageDrivenEndpoint jmsMessageDrivenEndpoint = new JmsMessageDrivenEndpoint(defaultMessageListenerContainer(), channelPublishingJmsMessageListener());
	jmsMessageDrivenEndpoint.setOutputChannel(replies());
...
public DefaultMessageListenerContainer defaultMessageListenerContainer() {
	DefaultMessageListenerContainer defaultMessageListenerContainer = new DefaultMessageListenerContainer();
	defaultMessageListenerContainer.setDestinationName("requests");
	return defaultMessageListenerContainer;
}
...
public JmsMessageDrivenEndpoint jmsIn() {
	JmsMessageDrivenEndpoint jmsMessageDrivenEndpoint = new JmsMessageDrivenEndpoint(defaultMessageListenerContainer(), channelPublishingJmsMessageListener());
	jmsMessageDrivenEndpoint.setOutputChannel(requests());
	return jmsMessageDrivenEndpoint;
}

@Bean
@ServiceActivator(inputChannel = "replies")
public MessageHandler outgoingReplies() {
	JmsSendingMessageHandler handler = new JmsSendingMessageHandler(jmsTemplate());
	handler.setDestinationName("replies");
	return handler;
}

@Bean
@ServiceActivator(inputChannel = "requests", outputChannel = "replies")
public ChunkResponse serviceActivator(ChunkRequest chunkRequest) throws Exception{
...
public MessageHandler outboundRequestsJmsSendingHandler() {
	JmsSendingMessageHandler handler = new JmsSendingMessageHandler(jmsTemplate());
	handler.setDestinationName("requestsQueue");
	return handler;
}
...
@Bean
public DefaultMessageListenerContainer outBoundRequestsListenerContainer() {
	DefaultMessageListenerContainer defaultMessageListenerContainer = new DefaultMessageListenerContainer();
	defaultMessageListenerContainer.setDestinationName("requestsQueue");
	return defaultMessageListenerContainer;
}

@Bean
public ChannelPublishingJmsMessageListener outBoundRequestsJmsMessageListener() {
	ChannelPublishingJmsMessageListener channelPublishingJmsMessageListener = new  ChannelPublishingJmsMessageListener();
	return channelPublishingJmsMessageListener;
}

@Bean
public JmsMessageDrivenEndpoint outBoundRequestsAdapter() {
	JmsMessageDrivenEndpoint jmsMessageDrivenEndpoint = new JmsMessageDrivenEndpoint(outBoundRequestsListenerContainer(), outBoundRequestsJmsMessageListener());
	jmsMessageDrivenEndpoint.setOutputChannel(inboundRequests());
	return jmsMessageDrivenEndpoint;
}
...
@Bean
@ServiceActivator(inputChannel = "outboundStaging")
public MessageHandler outboundStagingJmsSendingHandler() {
	JmsSendingMessageHandler handler = new JmsSendingMessageHandler(jmsTemplate());
	handler.setDestinationName("stagingQueue");
	return handler;
}
...
@Bean
public DefaultMessageListenerContainer inboundStagingListenerContainer() {
	DefaultMessageListenerContainer defaultMessageListenerContainer = new DefaultMessageListenerContainer();
	defaultMessageListenerContainer.setDestinationName("stagingQueue");
	return defaultMessageListenerContainer;
}

@Bean
public ChannelPublishingJmsMessageListener inboundStagingJmsMessageListener() {
	ChannelPublishingJmsMessageListener channelPublishingJmsMessageListener = new  ChannelPublishingJmsMessageListener();
	return channelPublishingJmsMessageListener;
}

@Bean
public JmsMessageDrivenEndpoint inboundStagingAdapter() {
	JmsMessageDrivenEndpoint jmsMessageDrivenEndpoint = new JmsMessageDrivenEndpoint(inboundStagingListenerContainer(), inboundStagingJmsMessageListener());
	jmsMessageDrivenEndpoint.setOutputChannel(inboundStaging());
	return jmsMessageDrivenEndpoint;
}

@Bean
@ServiceActivator(inputChannel = "inboundStaging")
public MessageHandler partitioningMessageHandler() throws Exception{
	AggregatorFactoryBean aggregatorFactoryBean = new AggregatorFactoryBean();
	aggregatorFactoryBean.setProcessorBean(partitioningMessageHandler());
	aggregatorFactoryBean.setOutputChannel(outboundReplies());
	...
	return aggregatorFactoryBean.getObject();
}
