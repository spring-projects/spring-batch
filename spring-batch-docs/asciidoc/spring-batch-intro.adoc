...
// TODO I removed "Simple as well as complex". What do you mean by that?
// What are you actually trying to convey to the reader?
...
Also, the database design team must ensure that the database index tables are designed with deadlock prevention and performance in mind.
