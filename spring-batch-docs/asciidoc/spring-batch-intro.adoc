...
SpringSource and Accenture collaborated to change this.
    ...
    some useful additional detail and real-life constraints that help to ensure
    ...
    // TODO This paragraph is marketing material. If this is a technical introduction to
    // a tool, this content is misplace.
...
Accenture has contributed previously proprietary batch processing
    ...
    enhancements, and the future roadmap. Accenture's contribution is based upon decades
    of experience in
...
_2a. Assigned to a batch instance by a partitioning table (described later in this section)._

_2b. Assigned to a batch instance by a portion of the value (such as 0000-0999, 1000 - 1999, and so on)._
