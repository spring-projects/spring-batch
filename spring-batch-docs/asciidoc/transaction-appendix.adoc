...
typical use case>> for a description of a stateful retry.  This means that if the the
...
the the input step (4.1) is part of the retry. It also makes clear that there are two
