...
WARNING: `DerbyPagingQueryProvider` is deprecated as of Spring Batch 6.1.0 and will be
removed in version 7.0.0, along with the rest of the Apache Derby support.
