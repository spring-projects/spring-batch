...
[[multiFileInputLocationPatterns]]
== Specifying Resources With a Location Pattern

Since version 6.1, `MultiResourceItemReaderBuilder` can resolve resources directly from
one or more location patterns, without requiring the resources to be resolved and
injected beforehand:
