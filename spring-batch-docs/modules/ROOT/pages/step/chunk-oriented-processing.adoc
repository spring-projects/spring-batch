...
.Chunk-oriented Processing
image::../../assets/images/chunk-oriented-processing.png[Chunk Oriented Processing, scaledwidth="60%"]
...
image::../../assets/images/chunk-oriented-processing-with-item-processor.png[Chunk Oriented Processing With Item Processor, scaledwidth="60%"]
