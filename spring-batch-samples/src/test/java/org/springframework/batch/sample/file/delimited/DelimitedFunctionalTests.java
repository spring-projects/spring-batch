 ...
 * @since 2.0
 */
@SpringJUnitConfig(locations = { "/org/springframework/batch/sample/file/delimited/job/delimited.xml",
...
class DelimitedFunctionalTests {
	...
	void testLaunchJobWithXmlConfig() throws Exception {
		...
		JobParameters jobParameters = new JobParametersBuilder()
			.addString("inputFile", "org/springframework/batch/sample/file/delimited/data/delimited.csv")
