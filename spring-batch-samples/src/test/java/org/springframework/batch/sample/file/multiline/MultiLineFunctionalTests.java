 ...
 * @since 2.0
 */
@SpringJUnitConfig(locations = { "/org/springframework/batch/sample/file/multiline/job/multiLine.xml",
		"/simple-job-launcher-context.xml", "/job-runner-context.xml" })
class MultiLineFunctionalTests {

	private static final String INPUT_FILE = "org/springframework/batch/sample/file/multiline/data/multiLine.txt";
