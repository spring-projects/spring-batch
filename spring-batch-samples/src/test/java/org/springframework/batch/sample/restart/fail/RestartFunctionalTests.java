 ...
 * @author Glenn Renfro
 */
@SpringJUnitConfig(locations = { "/org/springframework/batch/sample/restart/fail/job/failRestartSample.xml",
	...
	private JobExecution runJobForRestartTest() throws Exception {
		return jobLauncherTestUtils
			.launchJob(new DefaultJobParametersConverter().getJobParameters(PropertiesConverter.stringToProperties(
					"input.file=classpath:org/springframework/batch/sample/restart/fail/data/ImportTradeDataStep.txt")));
	}
