...
@SpringJUnitConfig(locations = { "/org/springframework/batch/sample/file/multilineaggregate/job/multilineJob.xml",
...
class MultilineAggregateJobFunctionalTests {
	...
	private final Resource output = new FileSystemResource("target/test-outputs/multilineStep-output.txt");
