...
package org.springframework.batch.sample.jobstep;
...
@SpringJUnitConfig(locations = { "classpath:/org/springframework/batch/sample/jobstep/job/jobStepSample.xml",
...
class JobStepFunctionalTests {
	...
	void testJobLaunch() throws Exception {
		...
		JobParameters jobParameters = new JobParametersBuilder()
			.addString("input.file", "org/springframework/batch/sample/jobstep/data/ImportTradeDataStep.txt")
			.toJobParameters();
