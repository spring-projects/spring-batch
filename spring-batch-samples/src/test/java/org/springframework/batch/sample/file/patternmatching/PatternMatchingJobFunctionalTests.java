...
@SpringJUnitConfig(locations = { "/org/springframework/batch/sample/file/patternmatching/job/multilineOrderJob.xml",
...
class PatternMatchingJobFunctionalTests {
	...
	private static final String EXPECTED = "org/springframework/batch/sample/file/patternmatching/data/multilineOrderOutput.txt";
