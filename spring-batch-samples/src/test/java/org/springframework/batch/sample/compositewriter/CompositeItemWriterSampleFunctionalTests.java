 ...
 */
package org.springframework.batch.sample.compositewriter;
...
@SpringJUnitConfig(
		locations = { "/org/springframework/batch/sample/compositewriter/job/compositeItemWriterSampleJob.xml",
