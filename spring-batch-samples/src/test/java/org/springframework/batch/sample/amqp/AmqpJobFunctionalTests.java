...
import org.springframework.batch.sample.amqp.AmqpMessageProducer;
...
@SpringJUnitConfig(locations = { "/org/springframework/batch/sample/amqp/job/amqp-example-job.xml",
